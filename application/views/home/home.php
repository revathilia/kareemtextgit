...
<div class="body-wrapper">    
    ...
    <div class="ltn__slider-area ltn__slider-3  section-bg-1" dir="<?php if($session == "eng"){echo "ltr";}else{echo "rtl";} ?>">
        <div class="<?php if($session == "eng"){echo "ltn__slide-one-active slick-slide-arrow-1 slick-slide-dots-1";}else{echo "ltn__slide-one-activear slick-slide-arrow-1 slick-slide-dots-1";} ?>">
            <?php if(!empty($banner)){
...
<div class="col-md-6">
        ...
        <img src="<?php echo base_url() ; ?>uploads/images/about/<?php echo $sec3_image ?>">
