    ...
    <div class="container hero">
                <div class="row">
                    <div class="col-12 col-lg-4">
                      ...
                      <a href="<?php echo base_url() ; ?>home/industry" class="btn btn-orange"><?php echo $this->Admin_model->translate("Shop Now") ; ?></a>
</div>
                    </div>
                    ...
                    <div class="ri-text">
                      ...
                      <h3 class="uni"> <?php echo $this->Admin_model->translate("Uniforms") ; ?></h3>
                      <a href="<?php echo base_url() ; ?>home/school" class="btn btn-blue"><?php echo $this->Admin_model->translate("Shop Now") ; ?></a>
                        </div>
</div>  
                    </div>
                </div>
