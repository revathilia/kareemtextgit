                                            ...
                                            <div class="product-img">
                                                ...
                                                <div class="product-action">
                                                    <ul>
                                                       ...
                                                       <?php $exists = $this->User_model->checkitem_in_wishlist('industry',$product['id'] ) ; ?>

                                                       <?php if($exists){ ?>

                                                         <li>
                                                            <a href="#" title="Wishlist"  class="add_to_wishlist" data-productid="<?php echo $product['id'] ?>" >
                                                                <i class="fa fa-heart" style="color: red;" aria-hidden="true"></i></a>
                                                        </li>
                                ...
                                <div class="row">
                                       ...
                                       <div class="col-lg-12">
                                        <div class="ltn__product-item ltn__product-item-3">
                                            ...
                                            <div class="product-info">
                                                <h2 class="product-title"><a href="<?php echo base_url() ; ?>home/product_details/<?php echo $product['id'] ?>"> <?php 
if($this->session->userdata('lang') == 'ar'){
     echo $product['ar_product_name'] ;
}else{
     echo $product['product_name'];
