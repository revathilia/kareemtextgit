...
<?php echo form_open('admin/addschool', $attributes, $hidden);?>
<div class="form-body">
<div class="row"> 
<div class="col-md-6">
...
<input class="form-control" placeholder="<?php echo $this->Admin_model->translate("school name") ?>" name="ar_school_name" type="text" value="">
</div>
</div>
</div>
...
<!-- 
  ...
  <div class="form-group">
    <label for="first_name">  Description</label>
        <textarea class="form-control contact" id="content1"   name="description" placeholder="Add description about school"></textarea>
</div>
</div>
</div>
  ...
  <div class="form-group">
    <label for="first_name">  Description - Arabic</label>
        <textarea class="form-control contact" id="content2"   name="ar_description" placeholder="Add description about school"></textarea>
</div>
</div>
</div>
 -->
...
<div class="form-actions"> <?php echo form_button(array('name' => 'hrsale_form', 'type' => 'submit', 'class' => 'btn btn-primary btn-block save', 'content' => '<i class="fa fa fa-check-square-o"></i>&nbsp;&nbsp;'.$this->Admin_model->translate("Save"))); ?> </div>
...
return   false  ;
  ...
  numItems = $('#classLevels select.extrastandards').length ;
  if(numItems > 1){
    var i = numItems ;
  }else{
    var i = 1 ;
