...
<div class='col-md-4'><h4><?php echo $this->Admin_model->translate("Add Symptoms") ?></h4></div>
...
<?php echo form_open('admin/addsymptom', $attributes, $hidden);?>
<div class="form-body">
<div class="row"> 
<div class="col-md-12">
<div class="form-group">
<label for="first_name"><?php echo $this->Admin_model->translate("Symptom name") ?></label>
<input class="form-control" placeholder="<?php echo $this->Admin_model->translate("Symptom name") ?>" name="symptom_name" type="text" value="">
</div>
</div>
</div>
...
<input class="form-control" placeholder="<?php echo $this->Admin_model->translate("Symptom name (Arabic)") ?>" name="ar_symptom_name" type="text" value="">
</div>
</div>
</div>
   ...
   <div class="row"> 
                <div class="col-md-12">
                  <div class="form-group">
                             ...
                             <label for="xin_employee_password"><?php echo $this->Admin_model->translate("Group") ?> </label>
                  ...
                  <!--   <select class="form-control inputfield select2_2" multiple="" name="dis_group[]">
                    ...
                    <option value="C"> Group C</option>
                     ...
                     <input class="form-control" placeholder="<?php echo $this->Admin_model->translate("Group") ?>" name="dis_group" type="text" value="">
