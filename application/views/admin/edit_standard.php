...
<div class="box-title row">
    <div class='col-md-4'><h4><?php echo $this->Admin_model->translate("Edit standard") ?></h4></div>
  ...
  <div class="card-content">
        ...
        <?php echo form_open('admin/update_standard', $attributes, $hidden);?>
        <div class="form-body">
          <div class="row"> 
            <input type="hidden" class = "userid" name="standardid" value="<?php echo $standard['id'] ?>">
                <div class="col-md-12">
                  <div class="form-group">
                    <label for="first_name"><?php echo $this->Admin_model->translate("Standard Name") ?></label>
                    <input class="form-control" placeholder="<?php echo $this->Admin_model->translate("Standard name") ?>" name="standard_name" type="text" value="<?php echo $standard['standard_name'] ?>">
                  </div>
                </div>
            </div>
...
<?php echo $this->Admin_model->select_html('class_type_master','id', 'type_id', 'class_type', 'edit', 'demo-chosen-select form-control required class_type', $standard['type_id'], '', '', ''); ?>
