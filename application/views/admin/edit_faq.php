...
<?php echo form_open('admin/update_faq', $attributes, $hidden);?>
...
<textarea class="form-control"   name="question" placeholder="<?php echo $this->Admin_model->translate("Question") ?>"><?php echo $que; ?></textarea>
</div>
</div>
...
<textarea class="form-control"   name="ar_question" placeholder="<?php echo $this->Admin_model->translate("Question") ?>"><?php echo $ar_que; ?></textarea>
</div>
</div>
...
<textarea class="form-control"   name="answer" placeholder="<?php echo $this->Admin_model->translate("Answer") ?>"><?php echo $answer; ?></textarea>
</div>
</div>
...
<textarea class="form-control"   name="ar_answer" placeholder="<?php echo $this->Admin_model->translate("Answer") ?>"><?php echo $ar_answer; ?></textarea>
</div>
</div>
