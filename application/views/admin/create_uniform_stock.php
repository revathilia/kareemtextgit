...
<br/>
 ...
 <form class="order_form" id="xin-form" method="POST" action="<?php echo base_url();?>admin/add_uniform_stock">
...
<input type="text" name="product_name" class="form-control" value="<?php echo $this->Admin_model->get_type_name_by_id('school_products','id', $pId ,'product_name') ?>" readonly>
