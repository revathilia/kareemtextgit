...
<div class='col-md-4'><h4>Edit Section 1 Content - About Us</h4></div>
...
<?php echo form_open('admin/update_value', $attributes, $hidden);?>
<div class="form-body">
<div class="row"> 
<div class="col-md-6">
...
<input type="hidden" name="old_image" id="old_image" value="<?php echo $data->logo ;?>">
 ...
 <div class="form-group">
       <?php if($data->logo !='' && $data->logo !='no file') {?>
                        <img   class="img-thumb" src="<?php echo base_url().'uploads/images/about/'.$data->logo;?>" style="height:100px !important;width:100px !important;  " id="img1">
                ...
                <div class="col-md-6">
                  <div class="form-group"> 
                   ...
                   <input class="form-control"  type="text" name="title_ar" value="<?php echo $data->title_ar ?>" >
                  </div>
                </div>
                ...
                <div class="col-md-6">
                  <div class="form-group"> 
                   ...
                   <input class="form-control"  type="text" name="content_ar" value="<?php echo $data->content_ar ?>" >
                  </div>
                </div>
