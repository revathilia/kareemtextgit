...
<div class="box-title row">
    <div class='col-md-4'><h4><?php echo $this->Admin_model->translate("Edit Translation Strings") ?></h4></div>
  ...
  <div class="card-content">
        ...
        <?php echo form_open('admin/update_string', $attributes, $hidden);?>
        <div class="form-body">
          <div class="row"> 

            <input type="hidden" class = "userid" name="stringid" value="<?php echo $id ?>">
               
                <div class="col-md-12">
                  <div class="form-group">
                    <label for="first_name"><?php echo $this->Admin_model->translate("String") ?></label>
                    <input class="form-control" placeholder="<?php echo $this->Admin_model->translate("String") ?>" name="string" type="text" value="<?php echo $string ?>">
                  </div>
                </div>
          ...
          <div class="row"> 
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <input class="form-control emails" placeholder="<?php echo $this->Admin_model->translate("English") ?>" name="english" type="text" value="<?php echo $English ?>">
                  </div>
                ...
                <div class="col-md-6">
                  ...
                  <div class="form-group">
                    ...
                    <input class="form-control contact" placeholder="<?php echo $this->Admin_model->translate("Arabic") ?>" name="arabic" type="text" value="<?php echo $Arabic ?>">
                  </div>
