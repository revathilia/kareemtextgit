...
<div class="box-title row">
    <div class='col-md-4'><h4><?php echo $this->Admin_model->translate("Add Coupon") ?></h4></div>
  ...
  <div class="card-content">
        ...
        <?php echo form_open('admin/addcoupon', $attributes, $hidden);?>
        <div class="form-body">
          <div class="row"> 
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <input class="form-control" placeholder="<?php echo $this->Admin_model->translate("Coupon Name") ?>" name="coupon_name" type="text" value="">
                  </div>
                </div>
               
               <div class="col-md-6">
                  <div class="form-group">
                    <label for="first_name"><?php echo $this->Admin_model->translate("Coupon Code") ?></label>
                    <input class="form-control" placeholder="<?php echo $this->Admin_model->translate("Coupon Code") ?>" name="coupon_code" type="text" readonly value="<?php echo $coupon_code ?>">
                  </div>
                </div>
...
<div class="col-md-6">
  ...
  <div class="row"> 
     ...
     <div class="col-md-4">
                  <div class="form-group">
                    ...
                    <option value="percent"><?php echo $this->Admin_model->translate("Industry") ?>  </option>              
                     <option value="amount"><?php echo $this->Admin_model->translate("School") ?> </option>
                      <option value="both" ><?php echo $this->Admin_model->translate("Both") ?> </option>
  ...
  <div class="form-group">
    <label for="first_name">  Discount Value</label>
        <input type="number" class="form-control contact" name="discount_value" placeholder="Add discount Value" value=""> 
</div>
</div>
</div>
  ...
  <div class="col-md-6">
  <div class="form-group">
    <label for="first_name">  Start From</label>
        <input type="date" class="form-control contact"   name="starts_from" placeholder="Add description about school" value="">
</div>
</div>

   <div class="col-md-6">
  <div class="form-group">
    <label for="first_name">  Ends On </label>
        <input type="date" class="form-control contact"   name="ends_on" placeholder="Add description about school" value="">
</div>
</div>
 ...
 <div class="row">
  ...
  <div class="form-group">
    <label for="first_name"> Unlimited Usage</label>
        <input type="checkbox"   name="unlimited_usage" placeholder="Add description about school"  value="Y">
</div>
</div>
  ...
  <div class="form-group">
    <label for="first_name"> Free shipping </label>
       <input type="checkbox"     name="shipping_free" placeholder="Add description about school"  value="Y">
</div>
</div>
