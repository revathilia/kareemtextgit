...
<?php echo form_open('admin/add_industry_product_price', $attributes, $hidden);?>
<div class="form-body"> 
 ...
 <table class="table table-bordered">  
    ...
    <?php foreach ($sizes as $value) {?>
      ...
      <?php if($this->Admin_model->check_id_exists('size_master',$value)){ ?>


      <input type="hidden" name="size[]" value="<?php echo $value ?>">
        
         <?php $priceDet = $this->Admin_model->get_single_data('industry_product_price_size_det',array('product_id'=>$products->id,'size_id' => $value , 'status' => 'Y'));
...
<div class="col-md-6">
        <div class='form-group'>
          ...
          <img   class="img-thumb" src="<?php echo base_url().'uploads/images/industry/'. $sizechart;?>" style="height:200px !important;width:200px !important;  " id="image">
          
           <a class="btn btn-xs btn-success" href="<?php echo site_url()?>download?type=images/industry&filename=<?php echo  $sizechart ;?>">Download</a><button class="btn btn-xs btn-warning" onclick="remove();return false;">Remove</button>
