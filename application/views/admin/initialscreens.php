...
<div class="box-title row">
    <div class='col-md-4'><h4><?php echo $this->Admin_model->translate("Add Initial Screen Data") ?></h4></div>
  ...
  <div class="card-content">
        ...
        <?php echo form_open('admin/update_initialscreens', $attributes, $hidden);?>
        <div class="form-body">
          <div class="row"> 
                ...
                <div class="col-md-12">
                  <div class="form-group">
                    <label for="first_name"><?php echo $this->Admin_model->translate("Brief") ?></label>
                   

                     <textarea class="form-control" id="content1"  placeholder="<?php echo $this->Admin_model->translate("Brief (English)") ?>" name="basic"><?php echo $basic ?></textarea>
                  ...
                  <div class="col-md-12">
                  <div class="form-group">
                    <label for="first_name"><?php echo $this->Admin_model->translate("Brief (Arabic)") ?></label>
                    
                    <textarea class="form-control" id="content2" placeholder="<?php echo $this->Admin_model->translate("Brief (Arabic)") ?>" name="ar_basic"><?php echo $ar_basic ?></textarea>
            ...
            <div class="row"> 
              <div class="col-md-12">
                <div class="form-group">
                  <label for="first_name"><?php echo $this->Admin_model->translate("Supporting Organizations(English)") ?></label>
                  <textarea class="form-control"  id="content3"  name="supporting" placeholder="Add Supporting Organizations"><?php echo $supporting ?></textarea>
             ...
             <div class="row"> 
              <div class="col-md-12">
                <div class="form-group">
                  <label for="first_name"><?php echo $this->Admin_model->translate("Supporting Organizations (Arabic)") ?></label>
                  <textarea class="form-control"  id="content4"  name="ar_supporting" placeholder="Supporting Organizations"><?php echo $ar_supporting ?></textarea>
  ...
  $("#xin-form").submit(function(e){
    ...
    $.ajax({
      ...
      success: function(JSON)
      {
        ...
        $('.save').prop('disabled', false);
        window.location.href="<?php echo base_url();?>admin/initialscreens";
        }
      },
      error: function() 
      {
