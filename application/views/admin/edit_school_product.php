...
<div class="box-title row">
    <div class='col-md-4'><h4><?php echo $this->Admin_model->translate("Edit Uniform") ?></h4></div>
 ...
 <div class="card-content">
      ...
      <?php $attributes = array('name' => 'edit_driver', 'id' => 'xin-form', 'autocomplete' => 'off');?>
        ...
        <?php echo form_open('admin/update_school_product', $attributes, $hidden);?>
        <div class="form-body">
          <div class="row"> 
            <input type="hidden" class = "userid" name="productid" value="<?php echo $product['id'] ?>">
                <div class="col-md-6">
                  <div class="form-group">
                    <label for="first_name"><?php echo $this->Admin_model->translate("Uniform Name") ?></label>
                    <input class="form-control" placeholder="<?php echo $this->Admin_model->translate("Uniform name") ?>" name="product_name" type="text" value="<?php echo $product['product_name'] ?>">
                  </div>
                </div>
...
<?php echo $this->Admin_model->select_html('uniform_categories','id', 'category_name', 'category_name', 'edit', 'demo-chosen-select form-control required category_name',  $product['category']  , '', '', ''); ?>
...
<?php   } ?>
    ...
    <legend>
      <?php echo $this->Admin_model->translate("Select School - Class level Relations to this product") ?></legend>
             ...
             <?php if(!empty( $school_relation )) {

               $c = 0; foreach ($school_relation as $srval) { 

 
       ?>

        <?php if($this->Admin_model->check_id_exists('school_master',$srval['school_id'])){ ?>
...
<div class="row existing" > 
      <div class="col-md-3">
                  ...
                  <div class="form-group">
                    ...
                    <select class=" form-control selectedschool" id="scl_<?php echo $c ?>" data-level="clev_<?php echo $c ?>" name="school[<?php echo $c ?>]" >
                    <option value="">  --Select--</option>
                   ...
                   <?php 
                    ...
                    <?php if($this->Admin_model->check_id_exists('school_master',$scl['id'])){ ?>
                      ...
                      $sclevels = str_replace('"','',$sclevels);
                       ...
                       ?>
                     <option data-level="<?php echo $sclevels ?>" <?php if($srval['school_id'] == $scl['id']){ echo "selected" ; } ?> value="<?php echo $scl['id'] ?>"><?php echo $scl['school_name'] ?></option>
                   <?php  } } ?>
...
<div class="col-md-6">
                   ...
                   <div class="form-group">
                    ...
                    <select class="select2_2 form-control inputfield selectedlevel" id="clev_<?php echo $c ?>"  multiple="" name="class_levels[<?php echo $c ?>][]">
                    
                    <?php 

                    $slevels = explode(',', $srval['class_level']) ;

                    foreach ($levels as  $lvl) { ?>
                     <option value="<?php echo $lvl['id'] ?>" <?php if(in_array($lvl['id'], $slevels)){ echo 'selected'  ;} ?>><?php echo $lvl['class_type'] ?></option>
                   <?php   } ?>
...
<div class="col-md-6">
 ...
 <?php } ?>
   ...
   <div class="col-md-3">
                <div class="form-group" >  
  <button id='extraUpload' class="btn btn-success btn-block btn-sm addAnother " style="text-align: right" type="button" ><i class="fa fa-plus"></i> Click here to add new School</button>
</div>
                </div>
...
<div id="classLevels">
            ...
            <div class="row"> 
                <div class="col-md-6">
                      <div class="form-group">
                      <label for="first_name"><?php echo $this->Admin_model->translate("Uniform Image") ?></label>
      ...
      <div class="col-md-6">
        <div class='form-group'>
          ...
          <img   class="img-thumb" src="<?php echo base_url().'uploads/images/school/'.$product['product_image'];?>" style="height:100px !important;width:100px !important;  " id="image">
          
           <a class="btn btn-xs btn-success" href="<?php echo site_url()?>download?type=images/school&filename=<?php echo $product['product_image'];?>">Download</a><button class="btn btn-xs btn-warning" onclick="remove();return false;">Remove</button>
...
<div class="row">
     ...
     <div class="form-group" >  
        ...
        <label class="control-label"> Product Images </label>
          ...
          <input type="hidden" class="form-control" value="<?php echo $additionalimages?>" id="ed_img" multiple="multiple" name="edit_img">
                  <div>

                   
                       <?php $img = explode(',', $additionalimages);
...
<div class="row">
  <div class="col-md-3" >  
        ...
        <div class="form-group" >             <div id='Uploadcontainer'>
...
<div class="col-md-4">
  <br/>
  <div class="form-group" >  
  <button id='extraUpload' class="btn btn-success btn-xs" type="button" onclick="return addAnother('Uploadcontainer')"><i class="fa fa-plus"></i> Add more images</button>
</div>
</div>
...
<div class="row">
  ...
  <div class="form-group">
    <label for="first_name">Short  Description</label>
        <textarea class="form-control contact" id="content1"   name="description" placeholder=" Add short description"><?php echo $product['description'] ?></textarea>
</div>
</div>
</div>
  ...
  <div class="form-group">
    <label for="first_name">Short Description - Arabic</label>
        <textarea class="form-control contact" id="content2"   name="ar_description" placeholder=" Add short description"><?php echo $product['ar_description'] ?></textarea>
</div>
</div>
</div>
                ...
                <div class="col-md-12">
                  <div class="form-group">
                    ...
                    foreach ($products as  $product) { ?>
                     <option value="<?php echo $product['id'] ?>"  <?php if(in_array($product['id'], $related_products)){echo "selected" ; } ?>><?php echo $product['product_name'] ?></option>
                   <?php   } ?>
...
return   false  ;
  ...
  numItems = $('select.selectedschool').length ;
  if(numItems > 1){
    var i = numItems ;
  }else{
    var i = 1 ;
