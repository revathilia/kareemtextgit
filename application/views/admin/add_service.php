...
<div class='col-md-4'><h4><?php echo $this->Admin_model->translate("Add Services") ?></h4></div>
...
<label for="first_name"><?php echo $this->Admin_model->translate("Service Name(English)") ?></label>
<input class="form-control" placeholder="<?php echo $this->Admin_model->translate("service name") ?>" name="service_name" type="text" value="">
</div>
</div>
...
<input class="form-control" placeholder="<?php echo $this->Admin_model->translate("service name") ?>" name="ar_service_name" type="text" value="">
</div>
</div>
...
<textarea class="form-control" id="content1"  name="description" placeholder="Add service description"></textarea>
...
<textarea class="form-control" id="content2"   name="ar_description" placeholder="Add service description"></textarea>
