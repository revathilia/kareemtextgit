...
<div class='col-md-4'><h4><?php echo $this->Admin_model->translate("Edit Payment method Icon") ?></h4></div>
<div class='col-md-6'></div>
<div class='col-md-2'> 
<a href="<?php echo base_url(); ?>admin/footer"><button class="btn btn-warning"><?php echo $this->Admin_model->translate("Edit Footer") ?></button></a>
</div>
</div>
...
<?php echo form_open('admin/update_icon', $attributes, $hidden);?>
<div class="form-body">
<div class="row"> 
<div class="col-md-6">
