...
<div class="box-title row">
    ...
    <div class='col-md-2'> 
            <a href="<?php echo base_url(); ?>admin/uniform_categories"><button class="btn btn-warning"><?php echo $this->Admin_model->translate("Category List") ?></button></a>
    </div>
</div>
  ...
  <div class="card-content">
        ...
        <?php echo form_open('admin/update_uniform_category', $attributes, $hidden);?>
        <div class="form-body">
          <div class="row"> 
