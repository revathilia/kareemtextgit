...
<div class="box-title row">
    <div class='col-md-4'><h4><?php echo $this->Admin_model->translate("Privacy Policy") ?></h4></div>
  ...
  <div class="card-content">
        ...
        <?php echo form_open('admin/update_privacy', $attributes, $hidden);?>
        <div class="form-body">
                ...
                <div class="col-md-12">
                  <div class="form-group">
                    <label for="first_name"><?php echo $this->Admin_model->translate("Content") ?></label>
                     ...
                     <textarea class="form-control" id="content1"  placeholder="<?php echo $this->Admin_model->translate("Content") ?>" name="privacy_policy"><?php echo  $data->privacy_policy ?></textarea>
                  ...
                  <div class="form-group">
                    ...
                    <textarea class="form-control" id="content2" placeholder="<?php echo $this->Admin_model->translate("Content - Arabic") ?>" name="privacy_policy_ar"><?php echo  $data->privacy_policy_ar ?></textarea>
