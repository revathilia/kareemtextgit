...
<div class='col-md-4'><h4><?php echo $this->Admin_model->translate("Add Subheading") ?></h4></div>
...
<?php echo form_open('admin/addgroup', $attributes, $hidden);?>
<div class="form-body">
<div class="row"> 
<div class="col-md-12">
<div class="form-group">
<label for="first_name"><?php echo $this->Admin_model->translate("Subheading - English") ?></label>
<input class="form-control" placeholder="<?php echo $this->Admin_model->translate("Subheading - English") ?>" name="group_name" type="text" value="">
</div>
</div>
</div>
...
<div class="col-md-12">
<div class="form-group">
<label for="first_name"><?php echo $this->Admin_model->translate("Subheading - Arabic") ?></label>
<input class="form-control" placeholder="<?php echo $this->Admin_model->translate("Subheading - Arabic") ?>" name="ar_group_name" type="text" value="">
</div>
</div>
</div>
