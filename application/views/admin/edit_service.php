...
<div class="box-title row">
    <div class='col-md-4'><h4><?php echo $this->Admin_model->translate("Edit Service Name") ?></h4></div>
    <div class='col-md-6'></div>
    <div class='col-md-2'> 
            <a href="<?php echo base_url(); ?>admin/services"><button class="btn btn-warning"><?php echo $this->Admin_model->translate("service List") ?></button></a>
    </div>
</div>
  ...
  <div class="card-content">
        ...
        <div class="form-body">
          <div class="row"> 
            ...
            <input type="hidden" class = "userid" name="serviceid" value="<?php echo $id ?>">
               
                <div class="col-md-12">
                  <div class="form-group">
                    <label for="first_name"><?php echo $this->Admin_model->translate("service Name") ?></label>
                    <input class="form-control" placeholder="<?php echo $this->Admin_model->translate("service name(English)") ?>" name="service_name" type="text" value="<?php echo $service_name ?>">
                  </div>
                </div>
               
                  <div class="col-md-12">
                  <div class="form-group">
                    <label for="first_name"><?php echo $this->Admin_model->translate("service Name(Arabic)") ?></label>
                    <input class="form-control" placeholder="<?php echo $this->Admin_model->translate("service name") ?>" name="ar_service_name" type="text" value="<?php echo $ar_service_name ?>">
                  </div>
                </div>
              ...
              <div class="row"> 
                <div class="col-md-6">
                      <div class="form-group">
                      <label for="first_name"><?php echo $this->Admin_model->translate("Service Icon") ?></label>
                 ...
                 <input type="hidden" name="iconname" id="iconname" value="<?php echo $service_icon;?>">

<div class="col-md-6">
        <div class='form-group'>
          <?php if($service_icon!='' && $service_icon!='no file') {?>
          <img   class="img-thumb" src="<?php echo base_url().'uploads/images/'.$service_icon;?>" style="height:100px !important;width:100px !important;background-color: blue " id="image">
          
           <a class="btn btn-xs btn-success" href="<?php echo site_url()?>download?type=images&filename=<?php echo $service_icon;?>">Download</a><button class="btn btn-xs btn-warning" onclick="remove();return false;">Remove</button>
          ...
          <?php } ?> </div>
            ...
            <div class="row"> 
              <div class="col-md-12">
                <div class="form-group">
                  <label for="first_name"><?php echo $this->Admin_model->translate("Service Description(English)") ?></label>
                  <textarea class="form-control" id="content1"  name="description" placeholder="Add service description"><?php echo $description ?></textarea>
             ...
             <div class="row"> 
              <div class="col-md-12">
                <div class="form-group">
                  <label for="first_name"><?php echo $this->Admin_model->translate("Service Description(Arabic)") ?></label>
                  <textarea class="form-control" id="content2"  name="ar_description" placeholder="Add service description"><?php echo $ar_description ?></textarea>
