...
<div class='col-md-4'><h4><?php echo $this->Admin_model->translate("Add address")?>  </h4></div>
...
<?php echo form_open('admin/add_address', $attributes, $hidden);?>
<div class="form-body">
...
<div class="row">
  ...
  <div class="form-group">
    <label for="first_name"> <?php echo $this->Admin_model->translate("Address")?></label>
        <textarea class="form-control contact" placeholder="address"  name="address" placeholder=" Add address"></textarea>
</div>
</div>
</div>
