...
<div class='col-md-4'><h4><?php echo $this->Admin_model->translate("Create Uniform Stock") ?></h4></div>
<div class='col-md-6'></div>
<div class='col-md-2'> 
<a href="<?php echo base_url(); ?>admin/school_inventory"><button class="btn btn-warning"><?php echo $this->Admin_model->translate("Uniform Stock List") ?></button></a>
</div>
</div>
...
<?php echo form_open('admin/add_uniform_stock', $attributes, $hidden);?>
<div class="form-body"> 
  <div class="row"> 
                  <div class="col-md-12">
  ...
  <?php echo $this->Admin_model->select_html('school_products','id', 'product_id', 'product_name', 'add', 'demo-chosen-select form-control required product_name', '', '', '', ''); ?>
...
function addAnother(hookID)
{
 ...
 $(document).on('change',".product_name", function()
   { 
    ...
    method:"POST",  
    data:{product_id:product_id,type:'school'},  
