...
<div class='col-md-2'> 
<a href="<?php echo base_url(); ?>admin/colors_i"><button class="btn btn-warning">All Colors</button></a>
</div>
</div>
...
<?php echo form_open('admin/update_i_color', $attributes, $hidden);?>
<div class="form-body">
...
$('.save').prop('disabled', false);
    window.location.href="<?php echo base_url();?>admin/colors_i";
}
},
error: function() 
{
