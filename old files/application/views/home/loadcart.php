...
foreach ($cart as $item){
 ...
 $productImage = $this->Admin_model->get_type_name_by_id('school_products','id',$item['id'],'product_image') ;
                                             ...
                                             ?>
                                            <a href="<?php echo base_url()?>home/product_details/<?php echo $item['id'] ?>"><img src="<?php echo base_url()?>uploads/images/<?php echo $item['type']?>/<?php echo $productImage ?>" alt="#"></a>
                                        </td>
                                        <td class="cart-product-info">
                                            <h4><a href="<?php echo base_url()?>home/product_details/<?php echo $item['id'] ?>">
