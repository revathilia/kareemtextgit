        ...
        */
        ...
        if($('.ltn__brand-logo-active').length){
            $('.ltn__brand-logo-active').slick({
                ...
                slidesToShow: 5,
                slidesToScroll: 1,
                prevArrow: '<a class="slick-prev ri-ht"><i class="fas fa-angle-left" alt="Arrow Icon"></i></a>',
                nextArrow: '<a class="slick-next le-ht"><i class="fas fa-angle-right" alt="Arrow Icon"></i></a>',
                responsive: [
                    {
                        breakpoint: 992,
                        settings: {
